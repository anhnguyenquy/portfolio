...
import { Box, Button, chakra, Container, Flex, Heading, Link, List, ListItem, SimpleGrid, Text, useColorModeValue } from '@chakra-ui/react'
...
import { BioSection, BioYear, GridItem, Paragraph, Section } from 'src/components'
    ...
    <Container>
      ...
      <Section delay={0.3}>
        ...
        <List>
          ...
          <ListItem>
            <Link href='https://www.linkedin.com/in/anh-nguyen-4366791b5' target='_blank'>
              <Button
                variant='ghost'
                colorScheme={useColorModeValue('teal', 'orange')}
